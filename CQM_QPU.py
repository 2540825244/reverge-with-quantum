...
from dimod import ConstrainedQuadraticModel, Integer, QuadraticModel, BinaryQuadraticModel, cqm_to_bqm
from dimod.generators.constraints import combinations
from dwave.system import DWaveSampler, EmbeddingComposite
import datetime

qs = [Integer(lower_bound=0, upper_bound=11, label='x' + str(i)) for i in range(11)] #question space
...
sampleset = sampler.sample(cqm_to_bqm(cqm))
...
#store results
print(best_samples)
f_output = open(f"output_QPU.txt", "w")
